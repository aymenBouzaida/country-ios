...
class BordersTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if let cell = tableView.dequeueReusableCell(withIdentifier: "countryCell", for: indexPath) as? CountryTableViewCell{
            ...
            cell.countyLBL.text = countries[indexPath.row].name
            cell.capitalLBL.text = countries[indexPath.row].capital
            
            if let imageUrlString = countries[indexPath.row].flagUrl{
